...
const contactInfo = [
  ...
  { icon: Linkedin, label: "LinkedIn", value: "Jair Costa Lopes Junior", action: () => window.open('https://www.linkedin.com/in/jair-costa-lopes-junior-ab6109199/', '_blank'), color: "text-blue-700" },
